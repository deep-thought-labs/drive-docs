...
For detailed descriptions of what each port type does, see [Port Reference]({{< relref "reference" >}}).
...
- [Port Reference]({{< relref "reference" >}}) - Detailed descriptions of all port types
- [Service Catalog]({{< relref "../catalog" >}}) - Complete service listings with port configurations
- [Environment Variables]({{< relref "../environment-variables" >}}) - Environment variables reference
