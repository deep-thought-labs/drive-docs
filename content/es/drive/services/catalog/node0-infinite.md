...
**Directorio de Servicio:** `node0-infinite`  
**Nombre de Servicio/Contenedor:** `infinite`  
**Red:** Infinite Mainnet  
**Tipo:** Blockchain Node

## Descripción

Nodo blockchain de mainnet para la red Infinite. Usa puertos estándar/predeterminados (sin desplazamiento). Esta es la red de producción principal para la blockchain Infinite.
...
**NODE_CHAIN_ID**  
El ID de cadena para la red mainnet de Infinite. Esto identifica de forma única la red blockchain.
...
El proceso completo de configuración de firewall, incluyendo cómo verificar y permitir SSH (puerto 22), se describe en detalle en la [Configuración de Firewall Guide]({{< relref "../ports/firewall-configuration" >}}). Los comandos mostrados a continuación son específicos para este servicio con los números de puerto correctos para Infinite Mainnet, pero por favor revisa la guía para el proceso de configuración completo.
...
5. Add rules to permitir conexiones entrantes for the required ports (26656, 26657)
...
3. Click the lock icon and enter your password to make changes
4. Click **Firewall Options...**
5. Add rules to permitir conexiones entrantes for the optional ports you want to expose (9090, 9091, 1317, 8545, 8546, 26660, 6065, 8100)
