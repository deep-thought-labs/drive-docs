...
- **Acceso desde el contenedor:** `node-logs`
- **Acceso desde el host:** `./drive.sh node-logs` (sintaxis simplificada) o `./drive.sh exec infinite node-logs` (sintaxis completa)
