---
title: "Parámetros Mainnet"
weight: 310
---

# Parámetros de Red Mainnet

Referencia completa de todos los parámetros de red configurados para Infinite Improbability Drive **mainnet**.
...
| Parámetro | Valor | Descripción |
|-----------|-------|-------------|
| `bond_denom` | `drop` | Denominación para bonds de staking |
...
| Parámetro | Valor | Descripción |
|-----------|-------|-------------|
| `mint_denom` | `drop` | Denominación para tokens acuñados |
