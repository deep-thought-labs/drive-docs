...
# Infinite Improbability Drive - Network Overview
...
**🌐 [infinitedrive.xyz](https://infinitedrive.xyz)** | **📚 [Official Documentation](https://docs.infinitedrive.xyz/en)**
...
- **[Tokenomics]({{< relref "tokenomics" >}})** - Complete tokenomics breakdown and pool allocation
- **[Network Parameters]({{< relref "network-parameters" >}})** - Inflation model and network configuration
- **[Genesis]({{< relref "genesis" >}})** - How to obtain and work with genesis files
